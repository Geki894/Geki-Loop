...
| --- | --- |
| Windows project-local installer | Integration test installs into a temporary Windows project |
...
| PostgreSQL/Supabase/SQL Server | Composable database module resolution tests |
| Frontend curated routing | Surface classifier policy and pinned upstream manifest |
| TDD/API/Playwright | Layered gate definitions and evidence requirements |
| GitHub Actions/auto-merge policy | Installed workflow plus runtime proof of required checks, auto-merge request, exact SHA, and protected `coding` target |
| Read-only dashboard | HTTP integration test; no mutation endpoints |
| Rollback/uninstall | Integration tests preserve user-modified files |
| Version lock and licenses | Repository validator checks manifests, versions, attribution |
| English/Vietnamese docs | Root documentation and language policy validation |
