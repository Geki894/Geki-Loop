...
1. Discover the problem, users, outcomes, constraints, and explicit technology preferences. Ask one focused question at a time when answers materially change the product. Product goal, primary user, observable outcome, out-of-scope boundary, and material security/cost constraints are non-delegable; never treat “pick everything” as permission to invent them. Reversible technical defaults may be recommended later with reasons.
